        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              <!-- chat item -->
              <div class="item">
                <img src="{{ asset('AdminLTE-2dist/img/user4-128x128.jpg') }}" alt="user image" class="online">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="{{ asset('AdminLTE-2dist/img/user3-128x128.jpg') }}" alt="user image" class="offline">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="{{ asset('AdminLTE-2dist/img/user2-160x160.jpg') }}" alt="user image" class="offline">
...
<!-- jQuery Knob Chart -->
<script src="{{ assset ('AdminLTE-2/bower_components/jquery-knob/dist/jquery.knob.min.js')}}"></script>
<!-- daterangepicker -->
...
<script src="{{ asset ('Admin:TE-2/dist/js/demo.js')}}"></script>
</body>
</html>
